...
BInc_Missing_FShared = Beta('BInc_Missing_FShared', 0, None, None, 0) #New
...
BVolume_HighRND = BVolume_High + sigma_volume_high * bioDraws('BVolume_HighRND','NORMAL') +\
                 ...
                 BMODEROUND_A_VH * MODEROUND_BIKE_Always +\
...
BFacility_SharedRND = BFacility_Shared + sigma_facility_shared * bioDraws('BFacility_SharedRND','NORMAL') +\
                ...
                BMODEROUND_N_FShared * MODEROUND_BIKE_Never + BInc_Missing_FShared * HHINC_Missing
